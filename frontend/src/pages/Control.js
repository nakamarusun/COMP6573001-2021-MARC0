  ...
  return (
    <div className="w-full h-full min-h-screen ">
      <div className="max-w-5xl h-full w-4/5 m-auto text-center flex flex-col items-center justify-start">
        ...
        <div><i class="fas fa-caret-square-up text-7xl lg pb-4 md:mt-2"></i></div>
        <div className="flex flex-row justify-center ">
          <div><i class="fas fa-caret-square-left text-7xl lg text-blue-800 "></i></div>
          <div><i class="fas fa-stop-circle text-7xl lg text-red-600 px-4 pb-4 "></i></div>
          <div><i class="fas fa-caret-square-right text-7xl lg text-yellow-500"></i></div>
        </div>
        <div><i class="fas fa-caret-square-down text-7xl text-pink-600"></i></div>
        </div>
      </div>
    </div>
